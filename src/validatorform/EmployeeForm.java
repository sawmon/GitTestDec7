...
public class EmployeeForm extends ValidatorForm{
	...
	public String toString() {
		return "EmployeeForm [employeeId=" + employeeId + ", employeeName="
				+ employeeName + ", deptId=" + deptId + ", position="
				+ position + ", fatherName=" + fatherName + ", motherName="
				+ motherName + ", permentAddress=" + permentAddress
				+ ", currentAddress=" + currentAddress + ", nationalId="
				+ nationalId + ", contactNo=" + contactNo + ", email=" + email
				+ ", salaryPerDay=" + salaryPerDay + ", overtimeRatePerHour="
				+ overtimeRatePerHour + ", accNumber=" + accNumber
